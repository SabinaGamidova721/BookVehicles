<?php
    ...
    if(isset($_POST['id'])) {
        ...
        echo "<div class='container'><div class='content'><div class='col text-center'><h3>Error: ID of the vehicle not provided</h3></div></div></div>";
    ...
    <div class="content">
        <div class="col text-center">
            <form method="post">
                ...
                <a href="vehicles.php" class="btn btn-secondary mt-3">Return to vehicles</a>
            </form>
        ...
        if(isset($_POST["but_del"])) {
         if(isset($_POST["confirmation_field"]) && $_POST["confirmation_field"] == "Hello World!") {
                ...
                $sql = "DELETE FROM vehicles WHERE id = :vehicleid";
			       ...
			       $stmt->bindValue(":vehicleid", $_POST["id"]);
					 $stmt->execute();
