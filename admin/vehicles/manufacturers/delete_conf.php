<?php
    ...
    if(isset($_POST['id'])) {
        ...
        echo "<div class='container'><div class='content'><div class='col text-center'><h3>Error: ID of the manufacturer not provided</h3></div></div></div>";
    ...
    <div class="content">
        <div class="col text-center">
            <form method="post">
                ...
                <a href="manufacturers.php" class="btn btn-secondary mt-3">Return to brands</a>
            </form>
