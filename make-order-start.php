...
$points_stmt = $conn->prepare('SELECT id, location FROM points');
$points_stmt->execute();
...
<!--                        </li>-->
    ...
    <div class="container overflow-hidden pt-2 pt-md-4 pt-lg-5">
        ...
        <form method="get" class="mb-5">
            <div class="form-row">
                <div class="col">
                    <select name="point" class="form-control pb-0">
                        <option value="">All Points</option>
                        <?php foreach ($points as $point_option): ?>
                            <option value="<?= $point_option['id'] ?>" <?= $point == $point_option['id'] ? 'selected' : '' ?>>
                                <?= htmlspecialchars($point_option['location']) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="make-order-finale.php?id=<?= $vehicle['id'] ?>" class="btn btn-primary">Order</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
